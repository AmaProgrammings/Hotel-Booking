        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Hotel className="h-6 w-6 text-hotel-400" />
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="#" className="text-gray-400 hover:text-white">News</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="#" className="text-gray-400 hover:text-white">Cancellation Options</Link></li>
              <li><Link to="#" className="text-gray-400 hover:text-white">COVID-19 Resources</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="#" className="text-gray-400 hover:text-white">Cookie Settings</Link></li>
            </ul>
          </div>
        </div>
        
        <div className="border-t border-gray-800 mt-10 pt-6">
          <p className="text-gray-400 text-center">© {new Date().getFullYear()} StayEase. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
