...
export const hotels: Hotel[] = [
  {
    ...
    description:
      "Luxurious beachfront resort with stunning ocean views, world-class spa services, and exceptional dining experiences.",
    ...
    rooms: [
      {
        ...
        description:
          "Spacious room with a king-sized bed and private balcony overlooking the ocean.",
        price: 299,
        capacity: 2,
        amenities: [
          "King Bed",
      ...
      },
      {
        ...
        name: "Premium Suite",
        description:
          "Luxury suite with separate living area, two bathrooms, and panoramic ocean views.",
        price: 499,
        capacity: 4,
        amenities: [
          "King Bed",
  ...
  },
  {
    ...
    description:
      "Rustic yet elegant mountain retreat with private cabins, stunning views, and outdoor activities for all seasons.",
    location: "Aspen, Colorado",
    rating: 4.6,
    price: 249,
    featured: true,
    images: [
      "https://stormmountainlodge.com/wp-content/uploads/2015/11/2I4A9467-e1450148529808.jpg",
    ...
    rooms: [
      {
        ...
        description:
          "Cozy cabin with a king-sized bed, fireplace, and private deck with mountain views.",
        price: 249,
        capacity: 2,
        amenities: [
          "King Bed",
      ...
      },
      {
        ...
        description:
          "Spacious suite with two bedrooms, full kitchen, and large living area with fireplace.",
        price: 399,
        capacity: 6,
        amenities: [
          "Two Bedrooms",
  ...
  },
  {
    ...
    description:
      "Modern boutique hotel in the heart of the city with stylish rooms and proximity to major attractions.",
    ...
    rooms: [
      {
        ...
        description:
          "Stylish room with a king-sized bed, city views, and modern amenities.",
        price: 199,
        capacity: 2,
        amenities: [
          "King Bed",
  ...
  },
  {
    ...
    description:
      "Tranquil desert retreat with stunning views, luxurious amenities, and a world-class golf course.",
    ...
    rooms: [
      {
        ...
        description:
          "Comfortable room with a king-sized bed and balcony with desert and mountain views.",
        price: 279,
        capacity: 2,
        amenities: [
          "King Bed",
      ...
      },
      {
        ...
        name: "Luxury Villa",
        description:
          "Private villa with pool, two bedrooms, and stunning desert views.",
        price: 599,
        capacity: 4,
        amenities: [
          "Two Bedrooms",
  ...
  },
  {
    ...
    description:
      "Peaceful lakefront property with private beach, water activities, and cozy accommodations.",
    ...
    rooms: [
      {
        ...
        name: "Lakefront Room",
        description:
          "Cozy room with a queen-sized bed and direct access to the lake.",
        price: 259,
        capacity: 2,
        amenities: [
          "Queen Bed",
      ...
      },
      {
        ...
        description:
          "Private cottage with one bedroom, full kitchen, and deck overlooking the lake.",
        price: 399,
        capacity: 4,
        amenities: [
          "Queen Bed",
